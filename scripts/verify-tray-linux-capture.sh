...
APP_PATH="${1:-./AgentWatch.AppImage}"
shift || true
...
REPORT="${AGENTWATCH_VERIFY_REPORT:-$SCRIPT_DIR/tray-verification-linux.json}"
SCREENSHOT="${AGENTWATCH_LINUX_TRAY_SCREENSHOT:-$SCRIPT_DIR/screenshots/linux-tray.png}"
CAPTURE_DELAY_SECONDS="${AGENTWATCH_LINUX_CAPTURE_DELAY_SECONDS:-3}"
...
capture_screenshot() {
  ...
  echo "No Linux screenshot tool found. Install gnome-screenshot, spectacle, grim, scrot, or ImageMagick import." >&2
  return 1
}
...
echo "Linux tray screenshot: $SCREENSHOT"
